...
| B6 | 目录树 + 文件面板 | 已有，重构迁移至 client 插件（✅ 2026-08-31 V3：privhub-files-explorer-v3 新插件——树同时显示文件夹与文件，每节点 ⋯ 操作菜单：详情/权限/收藏/下载/编辑/重命名/新建子文件夹/删除；旧 explorer/preview/shell-tabs 移入 _retired-v2 作退路，tag v2） |
