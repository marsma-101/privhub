...
.v3-card-dots { position:absolute; right:8px; top:8px; visibility:hidden; width:24px; height:24px; border-radius:6px; text-align:center; line-height:22px; font-size:13px; color:var(--muted); background:var(--panel2); border:1px solid var(--line); cursor:pointer; }
.v3-card-dots:hover { color:var(--accent); border-color:var(--accent); }
.file-card:hover .v3-card-dots { visibility:visible; }
        ...
        <div class="main-body">
          ...
          <div v-else-if="nav.viewMode === 'grid'" class="file-list">
            ...
            >
              ...
              <span class="v3-card-dots" title="操作" @click="onDots(e, $event)">⋯</span>
